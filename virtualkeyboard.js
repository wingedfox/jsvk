    ...
    var VirtualKeyboard = new function () {
        ...
        **************************************************************************/
        ...
        self.addLayout = function(l) {
            ...
            if (!_.isArray(alpha) || 47!=alpha.length) throw new Error ('VirtualKeyboard requires \'keys\' property to be an array with 47 items, '+alpha.length+' detected. Layout code: '+code+', layout name: '+name);
...
//                window.console.out = "Please wait, keyboard is not available";
        ...
        self.setVisibleLayoutCodes = function () {
            var codes = _.isArray(arguments[0])?arguments[0]:arguments
               ,filter = null
               ,code;
          ...
          */
          ...
          if (!el || !el.tagName) {
              ...
              */
              ...
              EM.addEventListener(el,'mousedown',IME.blurHandler);
        ...
        self.detachInput = function () {
            ...
            */
            if (nodes.attachedInput) {
                ...
                EM.removeEventListener(oe,'mousedown',IME.blurHandler);
